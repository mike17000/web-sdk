...
export const winLevelMap = {
	...
	6: {
		...
		sound: { sfx: 'sfx_bigwin_coinloop', bgm: 'bgm_winlevel_big' },
	...
	7: {
		...
		sound: { sfx: 'sfx_bigwin_coinloop', bgm: 'bgm_winlevel_superwin' },
	...
	8: {
		...
		sound: { sfx: 'sfx_bigwin_coinloop', bgm: 'bgm_winlevel_mega' },
	...
	9: {
		...
		sound: { sfx: 'sfx_bigwin_coinloop', bgm: 'bgm_winlevel_epic' },
	...
	10: {
		...
		sound: { sfx: 'sfx_bigwin_coinloop', bgm: 'bgm_winlevel_max' },
